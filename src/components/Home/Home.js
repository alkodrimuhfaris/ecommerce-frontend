              ...
              <Col xs="5" sm="4" md="3" lg="2" className="m-2">
                <Link to={`/product/${product.id}`} style={{ textDecoration: 'none', color: 'black' }}>
                  <Card className="shadoq">
                    <CardImg top width="100%" src={product.product_image_1 ? product.product_image_1 : photoDefault} alt="Product image" />
                    <Container className="my-3">
                      ...
                      <CardSubtitle className="text-muted store-style">{product.store_name || 'Tuku Store'}</CardSubtitle>
              ...
              <Col xs="5" sm="4" md="3" lg="2" className="m-2">
                <Link to={`/product/${product.id}`} style={{ textDecoration: 'none', color: 'black' }}>
                  <Card className="shadow">
                    <CardImg top width="100%" height="50%" src={product.product_image_1 ? product.product_image_1 : photoDefault} alt="Product image" />
                    <Container className="my-3">
                      <div className="title-style">{product.name}</div>
                      <CardSubtitle><strong className="text-success">{currencyFormat(product.price)}</strong></CardSubtitle>
                      <CardSubtitle className="text-muted store-style">{product.store_name || 'Tuku Store'}</CardSubtitle>
